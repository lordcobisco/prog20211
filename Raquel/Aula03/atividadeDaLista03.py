...
tipodecelulaUsuario = str (input ('Qual o tipo de célula desejado? Entre 1 e 10 \n'))
...
print ('Houve alteração na variável "densidade " inserida?', densidadedaUsuario == densidadeda)
...
print ('brilho:', brilholUsuario)
print ('contraste:', contrastelUsuario)
