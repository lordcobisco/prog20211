...
b += a
print(b)
# a += b (se colocado como parte do código, apareceria erro) # b is not automatically converted to integer type
...
b.shape = 3,4 # changes the shape o a
print(a.shape)

def f(x):
    print(id(x))
print(id(a)) # id is unique identifier of an object
f(a)
...
print(a,"\n")
s = a[1:3] # spaces added for clarity; could also be writeen "s = a[:,1:3]"
