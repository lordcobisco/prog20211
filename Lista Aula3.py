...
print ('Esse programa será para coletar dados para a inicialização do microscópio.')
...
# Calibração
calibracao_hor = (input("Digite a calibração no sentido horizontal (Digite 10x a letra 'm' e, em seguinda, 10x a letra 'a'):  \n"))
print ('A informação foi corretamente digitada: ', calibracao_hor)

calibracao_ver = (input("Digite a calibração no sentido horizontal (Digite 10x a letra 'a' e, em seguinda, 10x a letra 'z'):  \n"))
